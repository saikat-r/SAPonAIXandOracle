...
GATEWAY_STAT=$(ps -ef | grep gwrd | grep $SID | grep -v grep | wc -l)
WORKPROCESS_STAT=$(ps -ef | grep "dw.sap"$SID"" | grep $SID | grep -v grep | wc -l)
SAPSTART_SERV_STAT=$(ps -ef | grep -w sapstart | grep $SID | grep -v grep | wc -l)
STARTSRV_STAT=$(ps -ef | grep sapstartsrv | grep $SID | grep -v grep | wc -l)
INTRNT_COM_MNGR_STAT=$(ps -ef | grep icman | grep $SID | grep -v grep | wc -l)
COLLECTOR_PROC_STAT=$(ps -ef | grep "co.sap"$SID"" | grep -v grep | wc -l)
SEND_PROC_STAT=$(ps -ef | grep "se.sap"$SID"" | grep -v grep | wc -l)
INTRNT_GRPH_SRV_STAT=$(ps -ef | grep "ig.sap"$SID"" | grep -v grep | wc -l)


export LIBPATH=/usr/lib:/lib:/usr/sap/$SID/SYS/exe/run:/oracle/client/11x_64/instantclient:/opt/freeware/lib:/opt/freeware/lib

echo q | /sapmnt/$SID/exe/dpmon pf=/sapmnt/$SID/profile/$START_PROFILE l > $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt

DPMON_WORKPROCESS_STOP_STAT=$(grep -i DpMonInit.failed $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | wc -l)

DPMON_WORKPROCESS_DIA_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep DIA | grep -v grep | wc -l)
DPMON_WORKPROCESS_DIA_RUN_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep DIA | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_DIA_STOP_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep DIA | grep -i STOP | grep -v grep | wc -l)
DPMON_WORKPROCESS_DIA_WAIT_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep DIA | grep -i WAIT | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_DIA_HOLD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep DIA | grep -i HOLD | grep -v grep | wc -l)
DPMON_WORKPROCESS_DIA_PRIV_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep DIA | grep -i PRIV | grep -v grep | wc -l)

DPMON_WORKPROCESS_UPD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UPD | grep -v grep | wc -l)
DPMON_WORKPROCESS_UPD_RUN_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UPD | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_UPD_STOP_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UPD | grep -i STOP | grep -v grep | wc -l)
DPMON_WORKPROCESS_UPD_WAIT_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UPD | grep -i WAIT | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_UPD_HOLD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UPD | grep -i HOLD | grep -v grep | wc -l)
DPMON_WORKPROCESS_UPD_PRIV_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UPD | grep -i PRIV | grep -v grep | wc -l)


DPMON_WORKPROCESS_UP2_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UP2 | grep -v grep | wc -l)
DPMON_WORKPROCESS_UP2_RUN_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UP2 | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_UP2_STOP_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UP2 | grep -i STOP | grep -v grep | wc -l)
DPMON_WORKPROCESS_UP2_WAIT_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UP2 | grep -i WAIT | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_UP2_HOLD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UP2 | grep -i HOLD | grep -v grep | wc -l)
DPMON_WORKPROCESS_UP2_PRIV_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep UP2 | grep -i PRIV | grep -v grep | wc -l)

DPMON_WORKPROCESS_ENQ_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep ENQ | grep -v grep | wc -l)
DPMON_WORKPROCESS_ENQ_RUN_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep ENQ | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_ENQ_STOP_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep ENQ | grep -i STOP | grep -v grep | wc -l)
DPMON_WORKPROCESS_ENQ_WAIT_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep ENQ | grep -i WAIT | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_ENQ_HOLD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep ENQ | grep -i HOLD | grep -v grep | wc -l)
DPMON_WORKPROCESS_ENQ_PRIV_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep ENQ | grep -i PRIV | grep -v grep | wc -l)

DPMON_WORKPROCESS_BTC_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep BTC | grep -v grep | wc -l)
DPMON_WORKPROCESS_BTC_RUN_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep BTC | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_BTC_STOP_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep BTC | grep -i STOP | grep -v grep | wc -l)
DPMON_WORKPROCESS_BTC_WAIT_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep BTC | grep -i WAIT | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_BTC_HOLD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep BTC | grep -i HOLD | grep -v grep | wc -l)
DPMON_WORKPROCESS_BTC_PRIV_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep BTC | grep -i PRIV | grep -v grep | wc -l)

DPMON_WORKPROCESS_SPO_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep SPO | grep -v grep | wc -l)
DPMON_WORKPROCESS_SPO_RUN_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep SPO | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_SPO_STOP_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep SPO | grep -i STOP | grep -v grep | wc -l)
DPMON_WORKPROCESS_SPO_WAIT_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep SPO | grep -i WAIT | grep -i RUN | grep -v grep | wc -l)
DPMON_WORKPROCESS_SPO_HOLD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep SPO | grep -i HOLD | grep -v grep | wc -l)
DPMON_WORKPROCESS_SPO_HOLD_COUNT=$(cat $WORK_DIRECTORY/TOTAL_DPMON_WORKPROCESS.txt | grep SPO | grep -i HOLD | grep -v grep | wc -l)
#==========================================================================================================================
#LOG FILES
#==========================================================================================================================
AVAILABLE_LOG_STAT=$(tail -1 /usr/sap/$SID/"DVEBMGS"$SAP_SYSTEM_NO""/work/available.log | awk '{print $1}' | grep -w Unavailable | wc -l)
AVAILABLE_LOG_PERIOD=$(tail -1 /usr/sap/$SID/"DVEBMGS"$SAP_SYSTEM_NO""/work/available.log | awk '{print $2, $3, $4, $5, $6}')

VMCAVAILABLE_LOG_STAT=$(tail -1 /usr/sap/$SID/"DVEBMGS"$SAP_SYSTEM_NO""/work/VMCavailable.log | awk '{print $3}'  | cut -f 1,20 -d :)
VMCAVAILABLE_LOG_PERIOD=$(tail -1 /usr/sap/$SID/"DVEBMGS"$SAP_SYSTEM_NO""/work/VMCavailable.log | awk '{print $1, $2}')
...
echo "<tr>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#abebc6"><font color="#145a32">$DF_SAPBKP_MNTPNT</font></td>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#abebc6"><font color="#145a32">$DF_SAPBKP_ALCTN "%"</font></td>" >> $REPORT_NAME
echo "</tr>" >> $REPORT_NAME
...
echo "<tr>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#f9e79f"><font color="#7d6608">$DF_SAPBKP_MNTPNT</font></td>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#f9e79f"><font color="#7d6608">$DF_SAPBKP_ALCTN "%"</font></td>" >> $REPORT_NAME
echo "</tr>" >> $REPORT_NAME
...
echo "<tr>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#f5b7b1"><font color="#641e16">$DF_SAPBKP_MNTPNT</font></td>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#f5b7b1"><font color="#641e16">$DF_SAPBKP_ALCTN "%"</font></td>" >> $REPORT_NAME
echo "</tr>" >> $REPORT_NAME
...
echo "<tr>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#abebc6"><font color="#145a32">$DF_ORAARCH_MNTPNT</font></td>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#abebc6"><font color="#145a32">$DF_ORAARCH_ALCTN "%"</font></td>" >> $REPORT_NAME
echo "</tr>" >> $REPORT_NAME
...
echo "<tr>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#f9e79f"><font color="#7d6608">$DF_ORAARCH_MNTPNT</font></td>" >> $REPORT_NAME
echo "<td width="25%" bgcolor="#f9e79f"><font color="#7d6608">$DF_ORAARCH_ALCTN "%"</font></td>" >> $REPORT_NAME
echo "</tr>" >> $REPORT_NAME
...
echo "<td width="25%" bgcolor="#abebc6"><font color="#145a32">$DF_OLOGA_ALCTN "%"</font></td>" >> $REPORT_Ntr>" >> $REPORT_NAME
...
uuencode $REPORT_NAME $REPORT_NAME | mailx -s "subject" nayan.karmakar@linde.com
