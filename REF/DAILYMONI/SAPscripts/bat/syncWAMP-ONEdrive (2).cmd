...
echo     Sync WAMP files to OneDrive > C:\Users\in10c2\OneDrive\StartupSYNC\LOGs\SYNC.%computername%.%username%.%mydate%_%mytime%.log
...
echo. >> C:\Users\in10c2\OneDrive\StartupSYNC\LOGs\SYNC.%computername%.%username%.%mydate%_%mytime%.log
echo    ********************Start Copy of Website design files****************** >> C:\Users\in10c2\OneDrive\StartupSYNC\LOGs\SYNC.%computername%.%username%.%mydate%_%mytime%.log
echo.
echo    Start Copy of Website design files...
echo.
echo. >> C:\Users\in10c2\OneDrive\StartupSYNC\LOGs\SYNC.%computername%.%username%.%mydate%_%mytime%.log

xcopy C:\wamp\www\*.* C:\Users\in10c2\OneDrive\wamp\*.* /H /S /Y /G >> C:\Users\in10c2\OneDrive\StartupSYNC\LOGs\SYNC.%computername%.%username%.%mydate%_%mytime%.log
