...
echo $SERVTYPE,$CLUSTER,$SERVER_NAME,$PHY_SERVER_NAME,$PHY_IP,$SERVER_SLICE,$VLAN_ID,$SAP_SYSTEMS,$ABAP_SYSTEMS,$JAVA_SYSTEMS,$ABAP_HOSTNAMES,$JAVA_HOSTNAMES,$DB_SYSTEMS >> /home/users/in10c2/sumit/VLANmap/DCPAIX.`uname -n`.VLANsheet.CSV
