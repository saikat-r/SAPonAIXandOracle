...
sed s/myheader2/"VMSTAT collected $vmstat_count times with interval of $vmstat_sec seconds"/g bar_vmstat_CPU_$APP.$SID.$SNO.html > tempbar_vmstat_CPU_$APP.$SID.$SNO.html
