...
readarray SID < /home/users/in10c2/moni/tmp_ABAP_SID ; #echo ${SID[@]} ; echo ${#SID[@]} ; echo "${SID[2]}"
readarray ABAP_INSTANCE=( `cat "/home/users/in10c2/moni/tmp_ABAP_INSTANCE" ` ) ; #echo ${ABAP_INSTANCE[@]} ; echo ${#ABAP_INSTANCE[@]}
